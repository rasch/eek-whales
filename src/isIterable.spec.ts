...
test("isIterable", t => {
  ...
  t.ok(
    isIterable([1, 2, 3]),
    "given an array should return true"
  )

  t.ok(
    isIterable(new Map()),
    "given an empty Map should return true"
  )

  t.ok(
    isIterable(new Set()),
    "given an empty Set should return true"
  )

  t.ok(
    isIterable(new Set([1, 1, 2, 3])),
    "given a Set should return true"
  )

  t.ok(
    isIterable(""),
    "given an empty string should return true"
  )

  t.ok(
    isIterable("hello world"),
    "given a string should return true"
  )
