...
test("isDate", t => {
  ...
  t.ok(isDate(new Date()), "given 'new Date()' should return true")

  t.notOk(isDate(), "given no parameters should return false")

  t.notOk(isDate(Date.now()), "given 'Date.now()' should return false")
